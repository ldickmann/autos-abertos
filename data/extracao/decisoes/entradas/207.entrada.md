# Documento 207: Despacho (Pet 15504, 2 página(s))

Resposta esperada em `207.json`, JSON estrito no schema abaixo.
...
http://www.stf.jus.br/portal/autenticacao/autenticarDocumento.asp sob o código 99C7-4764-8E4E-DFC7 e senha C3B4-C234-30DA-43AE

[página 2]
PET 15504 / DF
realização de diligências complementares que reputa imprescindíveis
para a ultimação das investigações (e-Doc. 43).
