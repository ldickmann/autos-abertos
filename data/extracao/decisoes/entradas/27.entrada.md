# Documento 27: Despacho (Pet 15556, 2 página(s))

Resposta esperada em `27.json`, JSON estrito no schema abaixo.
...
http://www.stf.jus.br/portal/autenticacao/autenticarDocumento.asp sob o código 267A-3FC7-3180-377D e senha 6CF6-9D46-7B65-E2F5
...
manifestação sobre o pedido de conversão da prisão preventiva em
domiciliar, formulado por Fabiano Campos Zettel (e-Docs. 358 a 363),
bem como sobre o pedido de restituição de bens, formulado por Paulo
Sérgio Neves de Souza (e-Docs. 366 a 367).
