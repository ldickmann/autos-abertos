# Documento 121: Despacho (Inq 5026, 1 página(s))

Resposta esperada em `121.json`, JSON estrito no schema abaixo.
...
DESPACHO:
Vistos,
Trata-se de manifestação da autoridade policial, requerendo nova
prorrogação do prazo para conclusão das investigações por mais 60
(sessenta) dias.
Posto isso, considero que as razões apontadas para prorrogação, por
mais 60 (sessenta) dias, devem ser deferidas.
...
http://www.stf.jus.br/portal/autenticacao/autenticarDocumento.asp sob o código B63B-B77A-02D9-227C e senha 935E-372D-1BF7-9875
