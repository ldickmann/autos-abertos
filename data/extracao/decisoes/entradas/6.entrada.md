# Documento 6: Despacho (Pet 15556, 2 página(s))

Resposta esperada em `6.json`, JSON estrito no schema abaixo.
...
http://www.stf.jus.br/portal/autenticacao/autenticarDocumento.asp sob o código 71E6-B9C3-7C8D-0C90 e senha 386B-ABBF-9B45-482B
...
manifestação sobre o pedido formulado por FABIANO CAMPOS
ZETTEL (e-doc. 506).
