...
| 4 | Frontend: versão escura, minimalista, microinterações 3D | feito; contraste WCAG auditado (14/09): `tinta-3` e `fio-forte` ajustados, botão principal e alertas com cor explícita; auditoria empírica em 6 páginas × 2 temas sem falhas AA | revisar página inicial como "capa dos autos" |
