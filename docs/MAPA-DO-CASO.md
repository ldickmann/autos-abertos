...
Gerado em 2026-09-14T22:42+00:00 por `python -m stf mapa`. Listagem determinística da base; sem interpretação. Use para achar lacunas: o que ainda não foi coletado, extraído ou ligado.
...
- ANDRÉ MENDONÇA — grau 28, ministro, Supremo Tribunal Federal, papéis —, 443 asserções, origem portal
...
- Pet 15645: peticao 4, certidao 2, outro 1
