...
import type { Assercao, Aviso, CronologiaDados, Decisoes, DocumentoCompleto, Entidade, FonteExterna, FluxosDados, Materia, Grafo, TrajetosDados, Integridade, LinhaTempo, Meta, Processo, ProcessoResumo, Referencias, RodadaMudancas, Verbete } from "@/lib/tipos";
